...
:::{.hint-box}
Notable problems or caveats are listed in purple boxes.
:::
...
(Itäkeskus, Puotila, Kamppi, Kivistö) were surrounded by a walkable polygon with no paths
on the ground around the entrance building. This problem might be detected *after*
doing the routing and inspecting the resulting isochrones.
...
bus terminal and Tallinnanaukio, which required adding all the walkable paths to both
the shopping mall entrances and the neighboring paths.
